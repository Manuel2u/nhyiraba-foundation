      ...
      <div className="xl:mx-auto xl:container py-20 2xl:px-0 px-6">
        <div className="lg:flex items-center justify-between">
          <div className=" lg:w-1/2 w-full">
            ...
            >
              To serve as a catalyst in helping to tackle most pressing issues
              in society related to woman, children and the aged. To
              conscientize and create awareness among the poeple of poorest of
              the poor on prevailing socio-economic situation and encourage them
              for active participation in socio-economic development program...
            </p>
            <div className="w-24">
              <div className="bg-gray-100 shadow rounded-full flex items-center mt-10">
                <a
                  href="/about"
                  className="items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-sky-700 hover:bg-sky-800"
                >
                  Explore
                </a>
              </div>
            ...
            >
              ...
              <div className="w-full p-8">
                ...
                <p className="md:w-90 text-left text-base leading-6 mt-4 text-gray-600">
                  We proudly provide a broad array of vital support and
                  education for women, children and the aged in Africian
