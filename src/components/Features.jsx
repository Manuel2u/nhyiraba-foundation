        ...
        <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-white mt-6  shadow-lg rounded-lg dark:bg-sky-700 hover:bg-sky-900">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              The Mission is not to hand money out to people but to educate and
              train them to become financially independent and to also be useful
              citizens, innovators and inventors in their own small way.
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 mt-6 sm:mt-16 md:mt-20 lg:mt-24 bg-white shadow-lg rounded-lg dark:bg-sky-700 hover:bg-sky-900">
            ...
            <p className="text-md text-gray-500 dark:text-gray-300 py-4">
              THE LARBI FOUNDATION's single most important VISION tied to its
              MISSION is to help the needy poeple in our society through the
              creation of well-connected networks, providing training and
              education and acting as liaison between them and the networks.
            </p>
          </div>
          <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-lg dark:bg-sky-700 hover:bg-sky-900">
            ...
            <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
              The very purpose of THE LARBI FOUNDATION is to serve others. We
              responsibly take up societal issues and serve the community. TLF
              respects human rights and does not violate them in any form.
            </p>
          </div>
        </div>
      </div>
