        ...
        <div className="container px-4 mx-auto">
          <div class="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-sky-800 bg-sky-100 font-medium uppercase rounded-full shadow-sm">
                How we works
              </span>
              <h2 className="mb-12 text-4xl md:text-5xl leading-tight font-bold tracking-tighter">
                This is how the foundation get you covered
              </h2>
              <div className="flex flex-wrap -mx-4 text-center md:text-left">
                <div className="w-full md:w-1/2 px-4 mb-8">
                  <div className="inline-flex items-center justify-center mb-4 w-12 h-12 text-xl text-white bg-sky-800 font-semibold rounded-full">
                    1
                  </div>
